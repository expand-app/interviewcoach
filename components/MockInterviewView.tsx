...
export function MockInterviewView({ onEndRequest }: Props) {
  ...
  // NOTE: no "hearing you" pulse and no dead-mic banner — both were
  // removed on user request (they read as clutter/noise during a real
  // interview). Silent-stall recovery lives in the controller now (the
  // AI itself re-engages after ~25s of candidate silence).
